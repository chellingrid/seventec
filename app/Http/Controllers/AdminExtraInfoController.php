<?php namespace App\Http\Controllers;
	...
	class AdminExtraInfoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:2|max:50','width'=>'col-sm-10','placeholder'=>'Informação Extra'];
