<?php namespace App\Http\Controllers;
	...
	class AdminCoursesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:100','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Instituition','name'=>'instituition_id','type'=>'select2','validation'=>'required','width'=>'col-sm-10','datatable'=>'instituitions,name'];
			//$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:100','width'=>'col-sm-10','placeholder'=>'Curso'];
			//$this->form[] = ['label'=>'Show','name'=>'show','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'0|No;1|Yes','help'=>'Exibir opção nos formulários gerais'];
			# OLD END FORM
