<?php namespace App\Http\Controllers;
	...
	class AdminActivityTypesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:50','width'=>'col-sm-10','placeholder'=>'Tipo de Atividade'];
